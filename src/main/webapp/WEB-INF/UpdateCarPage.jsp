...
<body>
	...
	<div class="container mt-3 col-md-8">
		<div class="jumbotron" style="background-color:#efefef; padding:10px;border-radius:5px;">
			<h1 class="display-6">Update the Details of the Car</h1>
			<p>Mark the changes in the car and make it more Valuable</p>
		</div>
		<br>
		...
		<div class="">
			<sf:form action="/admin/updateCarDetails" method="post" modelAttribute="updateCarDetails">
				...
				<div class="form-group mb-5 mt-3 text-center">
					<button class="btn btn-primary" type="submit">Update Car Details</button>
				</div>			
